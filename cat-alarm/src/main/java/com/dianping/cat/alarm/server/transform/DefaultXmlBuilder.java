...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitCondition(Condition condition) {
      startTag(ENTITY_CONDITION, null, ATTR_INTERVAL, condition.getInterval(), ATTR_DURATION, condition.getDuration(), ATTR_ALERT_TYPE, condition.getAlertType());
   ...
   public void visitRule(Rule rule) {
      startTag(ENTITY_RULE, null, ATTR_START_TIME, rule.getStartTime(), ATTR_END_TIME, rule.getEndTime());
   ...
   public void visitServerAlarmRuleConfig(ServerAlarmRuleConfig serverAlarmRuleConfig) {
      startTag(ENTITY_SERVER_ALARM_RULE_CONFIG, null, ATTR_ID, serverAlarmRuleConfig.getId());
      ...
      endTag(ENTITY_SERVER_ALARM_RULE_CONFIG);
   }

   @Override
   public void visitSubCondition(SubCondition subCondition) {
      startTag(ENTITY_SUB_CONDITION, true, null, ATTR_TYPE, subCondition.getType(), ATTR_VALUE, subCondition.getValue());
   }
}
