...
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_DX;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_DXS;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_EMAIL;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_EMAILS;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_PHONE;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_PHONES;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_WEIXIN;
import static com.dianping.cat.alarm.receiver.Constants.ELEMENT_WEIXINS;

import static com.dianping.cat.alarm.receiver.Constants.ENTITY_ALERT_CONFIG;
...
import com.dianping.cat.alarm.receiver.IEntity;
...
public class DefaultSaxParser extends DefaultHandler {
   ...
   public static AlertConfig parse(InputStream in) throws SAXException, IOException {
      return parseEntity(AlertConfig.class, new InputSource(removeBOM(in)));
   }

   public static AlertConfig parse(Reader reader) throws SAXException, IOException {
      return parseEntity(AlertConfig.class, new InputSource(removeBOM(reader)));
   }

   public static AlertConfig parse(String xml) throws SAXException, IOException {
      return parseEntity(AlertConfig.class, new InputSource(new StringReader(removeBOM(xml))));
   }
   ...
   public void endElement(String uri, String localName, String qName) throws SAXException {
      if (uri == null || uri.length() == 0) {
         ...
         if (currentObj instanceof Receiver) {
            ...
            } else if (ELEMENT_DX.equals(currentTag)) {
               receiver.addDx(getText());
   ...
   private void parseForReceiver(Receiver parentObj, String parentTag, String qName, Attributes attributes) throws SAXException {
      if (ELEMENT_EMAILS.equals(qName) || ELEMENT_EMAIL.equals(qName) || ELEMENT_DXS.equals(qName) || ELEMENT_DX.equals(qName) || ELEMENT_PHONES.equals(qName) || ELEMENT_PHONE.equals(qName) || ELEMENT_WEIXINS.equals(qName) || ELEMENT_WEIXIN.equals(qName)) {
