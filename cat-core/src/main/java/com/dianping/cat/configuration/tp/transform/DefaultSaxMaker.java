...
public class DefaultSaxMaker implements IMaker<Attributes> {
   ...
   @Override
   public TpValueStatisticConfig buildTpValueStatisticConfig(Attributes attributes) {
      TpValueStatisticConfig tpValueStatisticConfig = new TpValueStatisticConfig();

      return tpValueStatisticConfig;
   }
