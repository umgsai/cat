...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitAtomicTreeConfig(AtomicTreeConfig atomicTreeConfig) {
      startTag(ENTITY_ATOMIC_TREE_CONFIG, true, null, ATTR_START_TYPES, atomicTreeConfig.getStartTypes(), ATTR_MATCH_TYPES, atomicTreeConfig.getMatchTypes());
   }
   ...
   public void visitServerFilterConfig(ServerFilterConfig serverFilterConfig) {
      ...
      if (serverFilterConfig.getAtomicTreeConfig() != null) {
         serverFilterConfig.getAtomicTreeConfig().accept(m_visitor);
      }
