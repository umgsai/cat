...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitDomain(Domain domain) {
      ...
      if (!domain.getTransactionTypes().isEmpty()) {
         for (String transactionType : domain.getTransactionTypes()) {
   ...
   public void visitTpValueStatisticConfig(TpValueStatisticConfig tpValueStatisticConfig) {
      startTag(ENTITY_TP_VALUE_STATISTIC_CONFIG, null);

      if (!tpValueStatisticConfig.getDomains().isEmpty()) {
         for (Domain domain : tpValueStatisticConfig.getDomains().values()) {
            domain.accept(m_visitor);
         }
      }

      endTag(ENTITY_TP_VALUE_STATISTIC_CONFIG);
   }
}
