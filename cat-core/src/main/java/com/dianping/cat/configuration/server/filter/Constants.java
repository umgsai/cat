...
public class Constants {
   ...
   public static final String ATTR_MATCH_TYPES = "match-types";

   public static final String ATTR_START_TYPES = "start-types";
   ...
   public static final String ENTITY_ATOMIC_TREE_CONFIG = "atomic-tree-config";
