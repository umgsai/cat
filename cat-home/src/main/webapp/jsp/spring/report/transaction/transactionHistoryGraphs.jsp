...
<table>
	...
	<tr>
		<td style="display:none">
			<div id="responseTrendMeta"><c:out value="${responseTrend}" /></div>
			<div id="hitTrendMeta"><c:out value="${hitTrend}" /></div>
			<div id="errorTrendMeta"><c:out value="${errorTrend}" /></div>
		</td>
	</tr>
</table>
<script type="text/javascript">
	var responseTrendData = ${empty responseTrend ? "{}" : responseTrend};
	var hitTrendData = ${empty hitTrend ? "{}" : hitTrend};
	var errorTrendData = ${empty errorTrend ? "{}" : errorTrend};
