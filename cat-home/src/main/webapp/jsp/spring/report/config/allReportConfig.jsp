...
<c:set var="activeConfigMenu" value="allReportConfig" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.xml-config-content { padding-top: 2px; padding-right: 8px; }
		.xml-config-content .editor { min-height: 520px; border: 1px solid #d5d5d5; }
		.xml-config-title { text-align: center; color: #d15b47; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="xml-config-content">
				<h4 class="xml-config-title">Report All合并</h4>
				<form name="transactionAllConfig" id="form" method="post" action="${contextPath}/mvc/s/config?op=allReportConfig">
