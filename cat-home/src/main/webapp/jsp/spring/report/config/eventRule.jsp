				...
				<table class="table table-striped table-condensed table-bordered table-hover" id="contents" width="100%">
					<thead>
						<tr>
							...
							<th width="10%">
								操作
								<a href="${contextPath}/mvc/s/config?op=eventRuleUpdate" class="btn btn-primary btn-xs">
						...
						<c:forEach var="item" items="${rules}">
							...
							<tr>
								...
								<td style="text-align:center;white-space:nowrap">
									<a href="${contextPath}/mvc/s/config?op=eventRuleUpdate&ruleId=${fn:escapeXml(item.id)}" class="btn btn-primary btn-xs">
										<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
									</a>
									<a href="${contextPath}/mvc/s/config?op=eventRuleDelete&ruleId=${fn:escapeXml(item.id)}" class="btn btn-danger btn-xs delete">
