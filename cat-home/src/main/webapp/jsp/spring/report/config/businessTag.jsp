...
<c:set var="activeConfigMenu" value="businessTag" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.business-tag-content { padding-top: 2px; padding-right: 8px; }
		.business-tag-content .editor { min-height: 520px; border: 1px solid #d5d5d5; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="business-tag-content">
				<form name="tagConfig" id="form" method="post" action="${contextPath}/mvc/s/business?op=tagConfig">
					<table class="table table-striped table-condensed table-hover">
						<tr>
							<td><h4 class="text-center text-danger">业务监控标签配置</h4></td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td style="text-align:center">
								<input class="btn btn-primary" id="tagConfig" type="submit" name="submit" value="提交" />
							</td>
						</tr>
					</table>
				</form>
