...
<c:set var="activeConfigMenu" value="storageGroupConfigUpdate" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="xml-config-content">
				<form name="storageGroupConfigUpdate" id="form" method="post" action="${contextPath}/mvc/s/config?op=storageGroupConfigUpdate">
