...
<c:set var="activeConfigMenu" value="sampleConfigUpdate" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.sample-config-content { padding-top: 2px; padding-right: 8px; }
		.sample-config-content .editor { min-height: 520px; border: 1px solid #d5d5d5; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="sample-config-content">
				<form name="sampleConfigUpdate" id="form" method="post" action="${contextPath}/mvc/s/config?op=sampleConfigUpdate">
