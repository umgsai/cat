...
<c:set var="activeConfigMenu" value="alertPolicy" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.alert-policy-content { padding-top: 2px; padding-right: 8px; }
		.alert-policy-content .editor { min-height: 520px; border: 1px solid #d5d5d5; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="alert-policy-content">
				<form name="alertPolicy" id="form" method="post" action="${contextPath}/mvc/s/config?op=alertPolicy">
					<table class="table table-striped table-condensed table-hover">
						<tr>
							<td><h4 class="text-center text-danger">告警策略配置</h4></td>
						</tr>
						<tr>
							<td>
