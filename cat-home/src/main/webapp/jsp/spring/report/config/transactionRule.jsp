...
<c:set var="activeConfigMenu" value="transactionRule" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.transaction-rule-content { padding-top: 2px; padding-right: 8px; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			...
			<div class="transaction-rule-content">
				<table class="table table-striped table-condensed table-bordered table-hover" id="contents" width="100%">
					<thead>
						<tr>
							...
							<th width="10%">
								操作
								<a href="${contextPath}/mvc/s/config?op=transactionRuleUpdate" class="btn btn-primary btn-xs">
					...
					<tbody>
						<c:forEach var="item" items="${rules}">
							...
							<tr>
								...
								<td><c:out value="${conditions[3]}" /></td>
								<td>
									<c:choose>
								...
								<td style="text-align:center;white-space:nowrap">
									<a href="${contextPath}/mvc/s/config?op=transactionRuleUpdate&ruleId=${fn:escapeXml(item.id)}" class="btn btn-primary btn-xs">
										<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
									</a>
									<a href="${contextPath}/mvc/s/config?op=transactionRuleDelete&ruleId=${fn:escapeXml(item.id)}" class="btn btn-danger btn-xs delete">
