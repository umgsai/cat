...
<c:set var="activeConfigMenu" value="alertDefaultReceivers" scope="request" />
<!doctype html>
<html lang="en">
<head>
	...
	<style>
		.alert-receivers-content { padding-top: 2px; padding-right: 8px; }
		.alert-receivers-content .editor { min-height: 520px; border: 1px solid #d5d5d5; }
	</style>
</head>
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="alert-receivers-content">
				<form name="alertDefaultReceivers" id="form" method="post" action="${contextPath}/mvc/s/config?op=alertDefaultReceivers">
					<table class="table table-striped table-condensed table-hover">
						<tr>
							<td><h4 class="text-center text-danger">默认告警人配置</h4></td>
						</tr>
						<tr>
							<td>
								<input id="content" name="content" value="" type="hidden" />
								<input name="allOnOrOff" id="allOnOrOff" type="hidden" value="" />
						...
						<tr>
							<td style="text-align:center">
								...
								&nbsp;&nbsp;
								<input class="btn btn-primary" type="button" id="allOn" value="全部告警" />
								&nbsp;&nbsp;
								<input class="btn btn-primary" type="button" id="allOff" value="暂停告警" />
							</td>
						</tr>
					</table>
				</form>
