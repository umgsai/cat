...
@Component("storageModelService")
public class CompositeStorageService extends BaseCompositeModelService<StorageReport> {
	@Resource(name = "storage-historical")
	private ModelService<StorageReport> historicalStorageService;
	...
	public synchronized void initialize() {
		if (historicalStorageService != null) {
			setServices(Collections.singletonList(historicalStorageService));
		}
		super.initialize();
	}
