...
public class StateReportService extends AbstractReportService<StateReport> {
	...
	private StateReport queryFromHourlyBinary(int id, Date period, String domain) throws DalException {
	...
	public StateReport queryMonthlyReport(String domain, Date start) {
		try {
			MonthlyReport entity = m_monthlyReportDao
									.findReportByDomainNamePeriod(start, domain, StateAnalyzer.ID,	MonthlyReportEntity.READSET_FULL);
	...
	public StateReport queryWeeklyReport(String domain, Date start) {
		try {
			WeeklyReport entity = m_weeklyReportDao
									.findReportByDomainNamePeriod(start, domain, StateAnalyzer.ID,	WeeklyReportEntity.READSET_FULL);
