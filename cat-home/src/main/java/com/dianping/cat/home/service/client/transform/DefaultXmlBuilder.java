...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitClientReport(ClientReport clientReport) {
      startTag(ENTITY_CLIENT_REPORT, null, ATTR_DOMAIN, clientReport.getDomain(), ATTR_START_TIME, toString(clientReport.getStartTime(), "yyyy-MM-dd HH:mm:ss"), ATTR_END_TIME, toString(clientReport.getEndTime(), "yyyy-MM-dd HH:mm:ss"));
   ...
   public void visitDomain(Domain domain) {
      startTag(ENTITY_DOMAIN, null, ATTR_ID, domain.getId(), ATTR_TOTALCOUNT, domain.getTotalCount(), ATTR_FAILURECOUNT, domain.getFailureCount(), ATTR_FAILUREPERCENT, domain.getFailurePercent(), ATTR_SUM, domain.getSum(), ATTR_AVG, domain.getAvg());
   ...
   public void visitMethod(Method method) {
      startTag(ENTITY_METHOD, true, null, ATTR_ID, method.getId(), ATTR_SERVICE, method.getService(), ATTR_TOTALCOUNT, method.getTotalCount(), ATTR_FAILURECOUNT, method.getFailureCount(), ATTR_FAILUREPERCENT, method.getFailurePercent(), ATTR_SUM, method.getSum(), ATTR_AVG, method.getAvg(), ATTR_QPS, method.getQps(), ATTR_TIMEOUT, method.getTimeout());
   }
}
