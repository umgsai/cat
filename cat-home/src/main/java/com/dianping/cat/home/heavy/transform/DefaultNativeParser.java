      ...
      switch (_field) {
         ...
         case 34:
            if (_type == 1) { 
              ...
              m_linker.onService(heavyCache, service);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Service service = new Service();
      ...
      switch (_field) {
         ...
         case 34:
            if (_type == 1) { 
              ...
              visitService(service);
              m_linker.onService(heavyCall, service);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Service service = new Service();
      ...
      switch (_field) {
         ...
         case 34:
            if (_type == 1) { 
              ...
              visitService(service);
              m_linker.onService(heavySql, service);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Service service = new Service();
