...
import static com.dianping.cat.home.dependency.format.Constants.ENTITY_DOMAIN;
...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitDomain(Domain domain) {
      startTag(ENTITY_DOMAIN, true, null, ATTR_ID, domain.getId(), ATTR_COLINSIDE, domain.getColInside());
   }

   @Override
   public void visitProductLine(ProductLine productLine) {
      startTag(ENTITY_PRODUCTLINE, null, ATTR_ID, productLine.getId(), ATTR_COLINSIDE, productLine.getColInside());
