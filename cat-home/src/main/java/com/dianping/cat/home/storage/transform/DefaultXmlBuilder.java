...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitStorage(Storage storage) {
      startTag(ENTITY_STORAGE, true, null, ATTR_ID, storage.getId(), ATTR_DEPARTMENT, storage.getDepartment(), ATTR_PRODUCTLINE, storage.getProductline(), ATTR_TITLE, storage.getTitle());
   }
   ...
   public void visitStorageGroup(StorageGroup storageGroup) {
      ...
      if (!storageGroup.getStorages().isEmpty()) {
         for (Storage storage : storageGroup.getStorages().values()) {
   ...
   public void visitStorageGroupConfig(StorageGroupConfig storageGroupConfig) {
      ...
      if (!storageGroupConfig.getStorageGroups().isEmpty()) {
         for (StorageGroup storageGroup : storageGroupConfig.getStorageGroups().values()) {
