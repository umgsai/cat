...
public class DefaultSaxParser extends DefaultHandler {
   ...
   public static Graph parse(InputStream in) throws SAXException, IOException {
      return parseEntity(Graph.class, new InputSource(removeBOM(in)));
   }

   public static Graph parse(Reader reader) throws SAXException, IOException {
      return parseEntity(Graph.class, new InputSource(removeBOM(reader)));
   }

   public static Graph parse(String xml) throws SAXException, IOException {
      return parseEntity(Graph.class, new InputSource(new StringReader(removeBOM(xml))));
   }
   ...
   private void parseForGraph(Graph parentObj, String parentTag, String qName, Attributes attributes) throws SAXException {
      if (ENTITY_ITEM.equals(qName)) {
         ...
         throw new SAXException(String.format("Element(%s) is not expected under graph!", qName));
      }
