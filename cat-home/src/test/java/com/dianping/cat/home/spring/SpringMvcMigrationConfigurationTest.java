...
import com.dianping.cat.home.spring.web.SpringMvcDependencyController;
...
import com.dianping.cat.home.spring.web.SpringMvcMonitorController;
...
import com.dianping.cat.home.spring.web.SpringMvcStatisticsController;
import com.dianping.cat.home.spring.web.SpringMvcStorageController;
...
public class SpringMvcMigrationConfigurationTest {
	...
	public void shouldFindSpringMvcMigrationControllerByDefaultComponentScan() {
		...
		Assert.assertTrue(beanClassNames.contains(SpringMvcDependencyController.class.getName()));
		...
		Assert.assertTrue(beanClassNames.contains(SpringMvcMonitorController.class.getName()));
		...
		Assert.assertTrue(beanClassNames.contains(SpringMvcStatisticsController.class.getName()));
		Assert.assertTrue(beanClassNames.contains(SpringMvcStorageController.class.getName()));
	}
