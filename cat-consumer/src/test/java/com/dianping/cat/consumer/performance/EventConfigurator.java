...
public class EventConfigurator extends AbstractResourceConfigurator {

	public static void main(String[] args) {
		generatePlexusComponentsXmlFile(new EventConfigurator());
	}

	protected Class<?> getTestClass() {
		return EventPerformanceTest.class;
	}
