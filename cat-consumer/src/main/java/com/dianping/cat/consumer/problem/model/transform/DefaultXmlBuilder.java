...
import static com.dianping.cat.consumer.problem.model.Constants.ATTR_FAILS;
...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitEntity(Entity entity) {
      ...
      if (entity.getGraphTrend() != null) {
         entity.getGraphTrend().accept(m_visitor);
      }
   ...
   public void visitGraphTrend(GraphTrend graphTrend) {
      startTag(ENTITY_GRAPH_TREND, true, null, ATTR_DURATION, graphTrend.getDuration(), ATTR_FAILS, graphTrend.getFails());
   }
