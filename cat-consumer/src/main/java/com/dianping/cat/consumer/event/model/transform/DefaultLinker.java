...
public class DefaultLinker implements ILinker {
   ...
   @Override
   public boolean onGraphTrend(final EventType parent, final GraphTrend graphTrend) {
      parent.setGraphTrend(graphTrend);
      return true;
   }

   @Override
   public boolean onGraphTrend(final EventName parent, final GraphTrend graphTrend) {
      parent.setGraphTrend(graphTrend);
      return true;
   }
