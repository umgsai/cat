...
import static com.dianping.cat.consumer.event.model.Constants.ENTITY_STATUSCODE;
...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitGraphTrend(GraphTrend graphTrend) {
      startTag(ENTITY_GRAPH_TREND, true, null, ATTR_DURATION, graphTrend.getDuration(), ATTR_COUNT, graphTrend.getCount(), ATTR_FAILS, graphTrend.getFails());
   }
