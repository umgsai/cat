      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onOperation(domain, operation);
            } else if (_type == 2) {
      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              visitDomain(domain);
              m_linker.onDomain(machine, domain);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Domain domain = new Domain();
      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onSegment(operation, segment);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Segment segment = new Segment();
      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onMachine(storageReport, machine);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Machine machine = new Machine();
