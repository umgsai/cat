...
public class DefaultSaxParser extends DefaultHandler {
   ...
   public static BusinessReport parse(InputStream in) throws SAXException, IOException {
      return parseEntity(BusinessReport.class, new InputSource(removeBOM(in)));
   }

   public static BusinessReport parse(Reader reader) throws SAXException, IOException {
      return parseEntity(BusinessReport.class, new InputSource(removeBOM(reader)));
   }

   public static BusinessReport parse(String xml) throws SAXException, IOException {
      return parseEntity(BusinessReport.class, new InputSource(new StringReader(removeBOM(xml))));
   }
   ...
   private void parseForBusinessItem(BusinessItem parentObj, String parentTag, String qName, Attributes attributes) throws SAXException {
      if (ENTITY_SEGMENT.equals(qName)) {
         ...
         throw new SAXException(String.format("Element(%s) is not expected under business-item!", qName));
      }

      m_tags.push(qName);
   }

   private void parseForBusinessReport(BusinessReport parentObj, String parentTag, String qName, Attributes attributes) throws SAXException {
      if (ENTITY_BUSINESS_ITEM.equals(qName)) {
         ...
         throw new SAXException(String.format("Element(%s) is not expected under business-report!", qName));
      }
   ...
   private void parseRoot(String qName, Attributes attributes) throws SAXException {
      if (ENTITY_BUSINESS_REPORT.equals(qName)) {
         BusinessReport businessReport = m_maker.buildBusinessReport(attributes);

         m_entity = businessReport;
   ...
   public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
      if (uri == null || uri.length() == 0) {
         if (m_objs.isEmpty()) { // root
            ...
            if (parent instanceof BusinessReport) {
               parseForBusinessReport((BusinessReport) parent, tag, qName, attributes);
